  ...
  return (
    <>
      <main className="min-h-screen bg-gray-50">
        {/* Hero Section */}
        <div className="bg-linear-to-r from-meadow-2 to-meadow-1 text-white py-16">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center">
              ...
              <p className="text-xl text-gray-100 max-w-2xl mx-auto">
                Get in touch with our team to learn more about OITEP and our
                innovative solutions for sodium-restricted diets.
              </p>
            </div>
          </div>
        </div>
            ...
            <div className="space-y-8">
              <div>
                ...
                <p className="text-gray-600 mb-8">
                  ...
                  our products, research, or partnership opportunities. Reach
